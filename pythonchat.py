...
messages = [
    {
        "role": "system",
        "content": "You are an assistant who doesn't use text formatting and don't try to bold or italicize text. Your output should have newlines around every 55 characters. Use your tools to best answer questions."
        + str(date),
    },
